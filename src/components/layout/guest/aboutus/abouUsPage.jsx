        ...
        <main className="w-full overflow-y-hidden overflow-x-hidden">
            ...
            <div className='aboutus_text2'>
                ...
                <div className='mt-5 text-center'>
                    <p className='w-1/2 text-center text-justify text_aboutus textaboutus_type2'>
            ...
            <div className='aboutus_text2'>
                ...
                <div className='mt-5 text-center mb-5'>
                    <p className='w-1/2 text-center text-justify text_aboutus textaboutus_type2 text-left'>
